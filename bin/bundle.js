...
/***/ function(module, exports, __webpack_require__) {
	...
	var plotBarGraph = function plotBarGraph(studentsData) {
	  ...
	  var svg = _d2.default.select('#bar-graph').append('svg').attr('class', 'bg1').attr('width', 700).attr('height', 500);

	  // xAxis and yAxis
	  var xScale = _d2.default.scaleLinear().domain([0.5, 5.5]).range([0, 600]);
	  var yScale = _d2.default.scaleLinear().domain([0, _d2.default.max(data)]).range([400, 0]);
	  var xAxis = _d2.default.axisBottom(xScale).ticks(5);
	  var yAxis = _d2.default.axisLeft(yScale);
	  var x = svg.append('g').attr('class', 'xAxis').attr('transform', "translate(50, 465)");
	  var y = svg.append('g').attr('class', 'yAxis').attr('transform', "translate(50, 65)");
	  x.call(xAxis);
	  y.call(yAxis);

	  // Axes labels
	  x.append('text').attr('class', 'x-label').attr('x', 300).attr('y', 30).text('#Yrs At Zilla');
	  y.append('text').attr('class', 'y-label').attr('x', -150).attr('y', -35).attr('transform', 'rotate(-90)').text('# of Students');

	  // Bars
	  var barsContainer = svg.append('g').attr('class', "bars").attr('transform', 'translate(50, 0)');

	  barsContainer.selectAll('.bar').data(data).enter().append('g').append('rect').attr('class', 'bar').attr('x', function (d, idx) {
	    return xScale(idx + 1) - 40;
	  }).attr('y', function (d) {
	    return yScale(d) + 65;
	  }).attr('width', 80).attr('height', function (d) {
	    return 400 - yScale(d);
	  }).text(function (d) {
	    return d;
	  });
	  ...
	  // bar labels
	  barsContainer.selectAll('g').append('text').attr('class', 'middle-anchored-text').attr('x', function (d, idx) {
	    return xScale(idx + 1);
	  }).attr('y', function (d) {
	    return yScale(d) + 60;
	  }).text(function (d) {
	  ...
	  // Graph title
	  svg.append('g').append('text').attr('class', 'middle-anchored-text title').attr('y', 30).attr('x', 350).text("Unexpected Exits by Years At Zilla");
	};

	var byYrsAtZilla = function byYrsAtZilla(records) {
	  var res = [0, 0, 0, 0, 0];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _d3Collection = __webpack_require__(6);

	var collection = _interopRequireWildcard(_d3Collection);

	var _d3ScaleChromatic = __webpack_require__(9);

	var _d3Scale = __webpack_require__(12);

	var _d3Axis = __webpack_require__(19);
	...
	exports.default = {
	  ...
	  min: _d3Array.min,
	  max: _d3Array.max,
	  schemeAccent: _d3ScaleChromatic.schemeAccent
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	   true ? factory(exports, __webpack_require__(13), __webpack_require__(6), __webpack_require__(14), __webpack_require__(16), __webpack_require__(17), __webpack_require__(18), __webpack_require__(15)) :
